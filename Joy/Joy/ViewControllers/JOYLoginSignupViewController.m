...
- (IBAction)changeToSignIn:(id)sender
{
    ...
    self.changeToSignUpButton.titleLabel.textColor = [UIColor colorWithWhite:1 alpha:0.5];
    self.changeToSignInButton.titleLabel.font = [UIFont boldSystemFontOfSize:18.0];
    self.changeToSignUpButton.titleLabel.font = [UIFont systemFontOfSize:16.0];
...
- (IBAction)changeToSignUp:(id)sender
{
    ...
    self.changeToSignInButton.titleLabel.textColor = [UIColor colorWithWhite:1 alpha:0.5];
    self.changeToSignUpButton.titleLabel.textColor = [UIColor whiteColor];
    self.changeToSignUpButton.titleLabel.font = [UIFont boldSystemFontOfSize:18.0];
    self.changeToSignInButton.titleLabel.font = [UIFont systemFontOfSize:16.0];
